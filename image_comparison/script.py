...
Зависимости: 
- pip install Pillow (написан на pillow-10.3.0)
...
class ImageComparer:
    ...
    def __init__(self, img1, img2):
        if img1.size != img2.size: raise ValueError("Изображения разного размера.")
        self.img1 = img1
        self.img2 = img2
...
if __name__ == "__main__":
    ...
    difference_generator = DifferenceImageGenerator(expectation_image, actual_image, Config.difference_path)
